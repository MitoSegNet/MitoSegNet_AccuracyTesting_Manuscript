...
Generate tables with percentage of false object detections
...
def create_data(path, save_path, save_path_error, seg_name):
    ...
    error_data.to_csv(save_path_error + os.sep + seg_name + "_error_counting_data.csv")
